...
MIDDLEWARE = [
    ...
    'django.contrib.messages.middleware.MessageMiddleware', # Recently Added, testing required it, but not sure yet if really necessery
...
MESSAGE_STORAGE = 'django.contrib.messages.storage.session.SessionStorage' # recently added not sure yet if really necessery
